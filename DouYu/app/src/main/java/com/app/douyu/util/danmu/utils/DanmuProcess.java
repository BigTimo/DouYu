package com.app.douyu.util.danmu.utils;
...
import com.app.douyu.util.danmu.client.DyBulletScreenClient;
...
//                        addDanmaku(true, txt);
    ...
    private void addDanmaku(boolean islive, String txt) {
        ...
        danmaku.timeOffset = mDanmakuView.getCurrentTime();
