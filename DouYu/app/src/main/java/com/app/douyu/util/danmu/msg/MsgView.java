package com.app.douyu.util.danmu.msg;
...
public class MsgView {
    ...
    public Map<String, Object> parseRespond(String data) {
        ...
        //type@=chatmsg/rid@=15177/uid@=17362136/nn@=supan6/txt@=2自刀有毛用吗/cid@=3e6c7d9f71a14ea12601000000000000/ic@=avatar@S017@S36@S21@S36_avatar/level@=21/sahf@=0/bnn@=/bl@=0/brid@=0/hc@=/el@=/�
